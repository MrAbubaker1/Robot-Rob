...
function changeModel(){
    console.log("Function changeModel is executed")
    let modelSpan = document.getElementById("model-text");
    if(modelName === "XYZ") {
        modelName = "CPRG";
        console.log("modelname changing from xyz to cprg");
        modelSpan.textContent = "Model CPRG";
    }
    else{
        modelName = "XYZ";
        console.log("modelname changing from cprg to xyz");
